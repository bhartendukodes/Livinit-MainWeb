        ...
        <div className="py-8 md:py-10">
          <div className="pb-4 md:pb-6 text-center">
            <h1 className="font-nacelle text-4xl font-semibold leading-tight tracking-tight md:text-5xl lg:text-6xl space-y-1">
              <span
                className="hero-line block text-white animate-[hero-reveal_0.8s_ease-out_forwards]"
              ...
              <span
                className="hero-line block animate-[hero-reveal_0.8s_ease-out_forwards,hero-gradient_8s_ease-in-out_infinite] bg-[length:200%_auto] bg-clip-text bg-[linear-gradient(90deg,var(--color-indigo-300),var(--color-indigo-400),var(--color-indigo-300),var(--color-indigo-400))] text-transparent"
            ...
            <div className="mx-auto mt-6 max-w-2xl">
              <p
                className="hero-line mb-6 text-lg text-gray-300 animate-[hero-reveal_0.8s_ease-out_forwards] leading-relaxed"
              ...
              <div
                className="hero-line mx-auto max-w-lg animate-[hero-reveal_0.8s_ease-out_forwards]"
              ...
              >
                <div className="flex flex-col gap-3 rounded-xl border border-gray-700/50 bg-gray-800/40 p-2 backdrop-blur-sm sm:flex-row sm:items-stretch sm:p-2.5">
                  ...
                  <button
                    type="button"
                    className="shrink-0 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 px-5 py-2.5 font-semibold text-white shadow-lg shadow-indigo-500/25 transition-all duration-300 hover:from-indigo-500 hover:to-purple-500 hover:shadow-indigo-500/30"
                  >
                    Generate My Room
                  </button>
                </div>
              ...
              <div
                className="hero-line mx-auto mt-10 w-full max-w-4xl overflow-hidden animate-[hero-reveal_0.8s_ease-out_forwards]"
